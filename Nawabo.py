...
\033[1;47m\033[1;31m      SMILING HACKER       \033[1;0m

\033[1;96m«-----------------\JD1;91NAWAB XADA\033[1;96m-----------------»
...
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈NAWAB XADA-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ m-----------------»"""
...
def menu():
    ...
    os.system('echo  NAWAB░░░░░░XADA░░JD░ETICAL░░HACKER | lolcat -a -F 0.1')

    os.system('echo  NAWAB░░░░░XADA██WEB██DEVELOPER░██ | lolcat -a -F 0.1')

    os.system('echo  P░░░░░92░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')

    os.system('echo  CONTACT  ░░░░░NO NEED░░92746_CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  CALOUR  | lolcat -a -F 0.1')
    ...
    os.system('echo  V| lolcat -a -F 0.1')

    os.system('echo  BLAVK HAT ETICAL HACKER AND A PROGRAMMER | lolcat -a -F 0.1')

    os.system('echo  LETS░░░░░ENJOY░░OUR░░░░░TOOL░░THANKS | lolcat -a -F 0.1')

    os.system('echo  ------ Your Mind is Your Best Weapon------&&date  | lolcat -a -F 0.1')

    os.system('echo ----------------NAWAB XADA----------------| lolcat')
    ...
    os.system('echo -----------------NAWAB XADA----------------| lolcat --animate')
    ...
    os.system('echo         Type python2 NAWANpy| lolcat --animate')
    ...
    os.system('echo [W]  NAWAB XADA4 MASTER Group-------- Tool----● | lolcat --animate')
